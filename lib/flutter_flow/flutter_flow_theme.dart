...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF572800);
  late Color secondary = const Color(0xFFB87333);
  late Color tertiary = const Color(0xFFE3B887);
  late Color alternate = const Color(0xFF8B4513);
  ...
  late Color accent3 = const Color(0xFF20B2AA);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3C1C00);
  late Color secondary = const Color(0xFFA6662D);
  late Color tertiary = const Color(0xFFD8A97A);
  late Color alternate = const Color(0xFF753A10);
  ...
  late Color secondaryBackground = const Color(0xFF262626);
  late Color accent1 = const Color(0xFFFF4500);
  late Color accent2 = const Color(0xFFFFC107);
  late Color accent3 = const Color(0xFF008B8B);
  late Color accent4 = const Color(0xFF6A5ACD);
